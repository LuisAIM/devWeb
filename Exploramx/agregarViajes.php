									...
									<form action="agregarViaje.php" 
										...
										<tr>
											...
											<td>
													<input type="text" 
													name="nombreViaje"
													id="nombre"><span id="errorNombreViaje" class="errorCampo"></span>
											</td>
										</tr>
										<tr>
											<td><b>Origen:</b>
											...
											<td>
													<input type="text" 
													name="nombreOrigen"
													id="nombreOrigen"><span id="errorNombreOrigen" class="errorCampo"></span>
											</td>
										</tr>
										<tr>
											<td><b>Destino:</b>
											...
											<td>
													<input type="text" 
													name="nombreDestino"
													id="nombreDestino"><span id="errorNombreDestino" class="errorCampo"></span>
											</td>
										</tr>									
										<tr>
											<td><b>Paquete:</b>
